        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientDescription = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientDescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IngredientDescriptions_Cocktails_IngredientDescription",
                        column: x => x.IngredientDescription,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientDescriptions_IngredientDescription",
                table: "IngredientDescriptions",
                column: "IngredientDescription");
        }
